...
토글의 형태로 작동한다. \index{Person\+\_\+\+Character@{Person\+\_\+\+Character}!action\+Fire@{action\+Fire}}
...
애니메이션 처리를 돕기 위해 현재 움직임에 대한 정보를 한꺼번에 얻을 수 있는 함수이다. 
\begin{DoxyParams}{Parameters}
{\em \+\_\+sprint,\+\_\+crouch,\+\_\+prone,\+\_\+jump,\+\_\+ironsights} & 캐릭터의 현재 행동을 알 수 있다. \\
\hline
{\em \+\_\+gun\+\_\+type} & 총기 종류 (서브머신건, 샷건, 스나이퍼건) 를 알 수 있다. \\
\hline
\end{DoxyParams}
